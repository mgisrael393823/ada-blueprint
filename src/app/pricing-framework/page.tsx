    ...
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <PremiumGate
            title="Complete Pricing Framework"
            teaser="Unlock unit-type pricing, premium tiers and concession strategies."
            buttonText="Access pricing guide"
            href="/pricing-incentive/full"
          />
